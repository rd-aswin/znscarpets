export default function DropdownMenu({ label = "Dropdown", children }) {
  return (
    <button
      type="button"
      className="flex items-center gap-[4px] sm:gap-[6px] 2xl:gap-[8px] text-[13px] sm:text-[14px] md:text-[16px] 2xl:text-[18px] font-medium text-white cursor-pointer transition-opacity hover:opacity-90 whitespace-nowrap shrink-0"
    >
      ...
      <svg
        ...
        className="w-[10px] h-[6px] sm:w-[12px] sm:h-[7px] 2xl:w-[15px] 2xl:h-[9px] shrink-0"
      >
        <path
